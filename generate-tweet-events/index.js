        ...
        var averageDelay = 23500;  // in miliseconds
        ...
        function produceTweetMessage(param) {
            var tech = Math.random() < 0.7;    
            var prefix = prefixes[Math.floor(Math.random() *(prefixes.length))] ;    
            var sessions = tech?oowSessions:j1Sessions;
            ...
            var tweetEvent = {
                ...
                , "text": `${prefix} at #${tech?'ukoug_tech17':'ukoug_apps17'} ${session.title}`
                , "isARetweet": 'N'
                ...
                , "tagFilter": tech?'ukoug_tech17':'ukoug_apps17'
